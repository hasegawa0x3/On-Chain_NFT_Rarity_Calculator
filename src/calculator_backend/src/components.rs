...
pub fn fetch_canister_data(input: String) -> (Vec<std::collections::HashMap<String, String>> , Vec<String>) {
...
pub fn canister_data_to_traits_value(canister_data: Vec<std::collections::HashMap<String, String>> ,trait_list: Vec<String>) -> std::vec::Vec<std::vec::Vec<String>> {
...
pub fn reverse_mat(input: Vec<Vec<String>>) -> Vec<Vec<String>> {
...
pub fn get_traits_count_freq_number(input: Vec<Vec<String>>) -> (Vec<Vec<f64>>, Vec<Vec<f64>>) {
...
pub fn rare_calc(input: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
...
pub fn score_calc(input: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
    let mut output: Vec<Vec<f64>> = Vec::new();
    for col in input {
...
pub fn add_max_min_minus_to_rarity_score(input: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
    let mut output: Vec<Vec<f64>> = Vec::new();
...
// pub fn trait_independence(input: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
...
// pub fn trait_cramers_v(input: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
//     let mut output: Vec<Vec<f64>> = vec![vec![0.0; input.len()]; input.len()];
//     for out_val in 0 ..=input.len() -2 {
//         for in_val in out_val+1 ..=input.len() -1 {
//             let key_set= independent_test(input[out_val].clone(), input[in_val].clone());
...
// pub fn trait_normalize(traits_value: Vec<Vec<String>>, traits_count: Vec<Vec<f64>>, traits_freq: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
